...
//                    'service_limit'=>array(self::HAS_ONE, 'ContractInfo', 'cust_id'), 
    ...
    public function searchNewList() {
        ...
        switch ($this->searchtype) {
            case 1:$criteria->compare('c.cust_name', $this->keyword, true);
                break;
            case 2:$criteria->compare('c.qq', $this->keyword, true);
                break;
            case 3:$criteria->compare('ww', $this->keyword, true);
                break;
            case 4:$criteria->compare('webchat', $this->keyword, true);
                break;
            default:break;
        }
        if ($this->dept > 0) {
    ...
    public function search() {
        ...
        switch ($this->searchtype) {
            case 1:$criteria->compare('c.cust_name', $this->keyword, true);
                break;
            case 2:$criteria->compare('ci.total_money', $this->keyword, true);
                break;
            case 3:$criteria->compare('ww', $this->keyword, true);
                break;
            case 4:$criteria->compare('webchat', $this->keyword, true);
        ...
        $criteria->select = "t.id,t.cust_id,c.cust_name,t.cust_type,c.category,d.name as category_name,c.qq,t.webchat,t.ww,ci.service_limit,t.eno,t.assign_eno,t.assign_time,t.next_time ";
        $criteria->join = " left join {{customer_info}} c on t.cust_id = c.id " .
                " left join {{users}} u on t.eno=u.eno " . 
                " left join {{dic}} d on c.category=d.code and d.ctype='cust_category' " .
                " left join {{contract_info}} ci on t.cust_id=ci.cust_id ";
