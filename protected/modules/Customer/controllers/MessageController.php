...
class MessageController extends GController {
    /**
    ...
    public function actionResend() {
        ...
        $ret = Utils::sendMessage($model->phone, $model->content);
    ...
    public function get_creator_text($data) {
        $val = $data->creator;
        $creatorArr = Users::model()->findAll('id=:id', array(':id' => $val));
