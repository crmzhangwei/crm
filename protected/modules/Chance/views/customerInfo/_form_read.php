...
<div class="form"> 
    <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
        ...
        $form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->controller->createUrl('update2', array('id' => $model->id,'module'=>$module)),
        ...
        <div id="tabs-1" aria-labelledby="ui-id-29" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-hidden="false" style="display: block;">
            <?php $this->renderPartial('_baseinfo_read', array('model' => $model, 'user' => $user, 'form' => $form)); ?>
            <br/>
