...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" role="form" action="" id="nodeForm"> 
            <input type="hidden" name="node[id]" value="<?php echo $privilege['id'];?>">
            <div class="form-group">
                ...
                <div class="col-sm-5 col-xs-12">
                    ...
                    $this->widget('ext.tree.TreeWidget',array(
                        ...
                        'pid'           => 'pid',                   
                        'treeType'      => false, 
                        'bindSelectValue' => $privilege['parent_id'],
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5 col-xs-12">
                    <input name="node[name]" class="form-control" id="node_name" type="text" placeholder="节点名称" value="<?php echo $privilege['name'];?>" />
                </div>
            </div>  
            ...
            <div class="form-group" id="show_url" >
                ...
                <div class="col-sm-8 col-xs-12">
                    <input name="node[url]" class="form-control" id="node_url" value="<?php echo $privilege['url'];?>" type="text" placeholder="例 /System/permission/index" />
                </div>
            </div> 
    ...
    $(function() {
        ...
        public.validate({
            ...
            submitHandler: function(form) {
                public.AjaxSaveForm({
                    obj: $("#saveNode"),
                    url: '<?php echo $this->createUrl("/User/menuInfo/editNode"); ?>',
