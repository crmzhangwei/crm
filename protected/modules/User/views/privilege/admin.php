...
$this->pageTitle = '角色-权限分配页面';
$this->breadcrumbs = array(
    '权限管理' => array('/User/privilege/admin'),
    '角色-权限分配页面',
);
?>
<div class="row">
    <div class="col-sm-12">
        <div class="tabbable">
            <ul class="nav nav-tabs padding-12 tab-color-blue" id="myTab4">
                ...
                <li class="active">
                    <a href="<?php echo Yii::app()->createUrl('/User/privilege/admin'); ?>">角色功能分配</a>
                </li>
                            ...
                            <div class="col-sm-12 no-padding-top">
                                <div class="col-xs-7" style="padding-left:50px;">
                                    ...
                                    <h5 class="row header lighter">
                                        <span class="col-xs-6 smaller"> 选择角色：<strong id="selRoleName"></strong></span>
                                        ...
                                        <table id="roles_list" class="table table-bordered table-projects table-hover">
                                            ...
                                            <tbody>
                                                <?php 
                                                 ...
                                                 $role_list = $dataProvider->getData();
                                                 if($role_list):
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $("#saveBtn").click(function(){
           ...
           public.Ajax({
                url: '<?php echo $this->createUrl('/User/privilege/assignRolePermission');?>',
